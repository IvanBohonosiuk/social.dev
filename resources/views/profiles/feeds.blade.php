...
@section('content')
    ...
    <div class="container">
        <div class="row">
            ...
            <main class="col-xl-6 push-xl-3 col-lg-12 push-lg-0 col-sm-12 col-xs-12">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active inline-items" data-toggle="tab" href="#home-1" role="tab" aria-expanded="true">
                                    ...
                                    <svg class="olymp-status-icon"><use xlink:href="/public/icons/icons.svg#olymp-status-icon"></use></svg>
                            ...
                            <li class="nav-item">
                                <a class="nav-link inline-items" data-toggle="tab" href="#profile-1" role="tab" aria-expanded="false">
                                    ...
                                    <svg class="olymp-multimedia-icon"><use xlink:href="/public/icons/icons.svg#olymp-multimedia-icon"></use></svg>
                            ...
                            <li class="nav-item">
                                <a class="nav-link inline-items" data-toggle="tab" href="#blog" role="tab" aria-expanded="false">
                                    <svg class="olymp-blog-icon"><use xlink:href="/public/icons/icons.svg#olymp-blog-icon"></use></svg>
                ...
                <div class="ui-block">
                    <div class="widget w-wethear">
                        ...
                        <div class="wethear-now inline-items">
                            ...
                            <svg class="olymp-weather-partly-sunny-icon"><use xlink:href="/public/icons/icons-weather.svg#olymp-weather-partly-sunny-icon"></use></svg>
                        </div>
                        ...
                        <ul class="weekly-forecast">
                            ...
                            <li>
                                ...
                                <svg class="olymp-weather-sunny-icon"><use xlink:href="/public/icons/icons-weather.svg#olymp-weather-sunny-icon"></use></svg>
                            ...
                            <li>
                                ...
                                <svg class="olymp-weather-cloudy-icon"><use xlink:href="/public/icons/icons-weather.svg#olymp-weather-cloudy-icon"></use></svg>
                            ...
                            <li>
                                ...
                                <svg class="olymp-weather-rain-icon"><use xlink:href="/public/icons/icons-weather.svg#olymp-weather-rain-icon"></use></svg>
                            ...
                            <li>
                                ...
                                <svg class="olymp-weather-storm-icon"><use xlink:href="/public/icons/icons-weather.svg#olymp-weather-storm-icon"></use></svg>
                            ...
                            <li>
                                ...
                                <svg class="olymp-weather-snow-icon"><use xlink:href="/public/icons/icons-weather.svg#olymp-weather-snow-icon"></use></svg>
                            ...
                            <li>
                                ...
                                <svg class="olymp-weather-wind-icon-header"><use xlink:href="/public/icons/icons-weather.svg#olymp-weather-wind-icon-header"></use></svg>
                                    ...
                                    <div class="card">
                                        <div class="card-header" role="tab" id="headingOne-1">
                                            ...
                                            <h5 class="mb-0">
                                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne-1" aria-expanded="true" aria-controls="collapseOne-1">
                                                    Breakfast at the Agency<svg class="olymp-dropdown-arrow-icon"><use xlink:href="/public/icons/icons.svg#olymp-dropdown-arrow-icon"></use></svg>
                                                </a>
                                            </h5>
                                        </div>
                                        ...
                                        <div id="collapseOne-1" class="collapse" role="tabpanel" >
                                            ...
                                            <div class="place inline-items">
                                                <svg class="olymp-add-a-place-icon"><use xlink:href="/public/icons/icons.svg#olymp-add-a-place-icon"></use></svg>
                                        ...
                                        <div class="card-header" role="tab" id="headingTwo-1">
                                            ...
                                            <h5 class="mb-0">
                                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo-1" aria-expanded="true" aria-controls="collapseTwo-1">
                                                    Send the new “Olympus” project files to the Agency<svg class="olymp-dropdown-arrow-icon"><use xlink:href="/public/icons/icons.svg#olymp-dropdown-arrow-icon"></use></svg>
                                                </a>
                                            </h5>
                                        </div>
                ...
                <div class="ui-block">
                    <div class="widget w-birthday-alert">
                        <div class="icons-block">
                            <svg class="olymp-cupcake-icon"><use xlink:href="/public/icons/icons.svg#olymp-cupcake-icon"></use></svg>
                            <a href="#" class="more"><svg class="olymp-three-dots-icon"><use xlink:href="/public/icons/icons.svg#olymp-three-dots-icon"></use></svg></a>
                        </div>
                ...
                <div class="ui-block">
                    <div class="widget w-action">
                        ...
                        <div class="content">
                            ...
                            <a href="01-Landing%20Page.html" class="btn btn-bg-secondary btn-md">Register Now!</a>
                        </div>
                    </div>
                </div>
